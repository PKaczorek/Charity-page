  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Lista Instytucji</h1>
        ...
        <table class="table table-bordered table-hover">
          ...
          <tr>
            ...
            <th>Opis</th> <!-- Dodajemy nagłówek kolumny dla opisu -->
            <th>Akcje</th>
          </tr>
          </thead>
          <tbody>
          ...
          <c:forEach items="${institutions}" var="institution">
            <tr>
              ...
              <td>${institution.description}</td> <!-- Dodajemy komórkę dla opisu -->
              <td>
                <a href="/homeAdmin/editInstitution/${institution.id}" class="btn btn-warning">Edytuj</a>
                <a href="/homeAdmin/deleteInstitution/${institution.id}" class="btn btn-danger" onclick="return confirm('Czy na pewno chcesz usunąć?');">Usuń</a>
              </td>
            </tr>
          </c:forEach>
          </tbody>
        ...
        <a href="/homeAdmin/addInstitutionPage" class="btn btn-success mb-4">Dodaj Nową Instytucję</a>
