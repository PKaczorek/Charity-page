  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Zarządzanie użytkonikamy</h1>
          ...
          <c:forEach items="${users}" var="user">
            <tr>
              <td>${user.email}
                ...
                <c:if test="${user.id == loggedUser.id}">*</c:if>
              ...
              <td>
                <a href="/homeAdmin/updateUserRole/${user.id}" class="btn btn-danger" onclick="return confirm('Czy na pewno chcesz tego użytkownika nadać role admina?');">Nadaj uprawnienia admina</a>
                <a href="/homeAdmin/deleteUserRole/${user.id}" class="btn btn-danger" onclick="return confirm('Czy na pewno chcesz tego użytkownika usunąc jako admin?');">Odbierz uprawnienia admina</a>
                <a href="/homeAdmin/deleteUser/${user.id}" class="btn btn-danger" onclick="return confirm('Czy na pewno chcesz usunąć tego użytkownika');">Usuń użytkownika</a>
